...
public class Fragment2Sao extends Fragment implements ViewDanhGia{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.layout_fragment_danhgia_2sao,container,false);
    ...
    public void HienThiDanhSachDanhGia(List<DanhGia> danhGias) {
        for(int i = 0 ; i < danhGias.size(); i++){
            if(danhGias.get(i).getSOSAO()==2){
                danhGiaList.add(danhGias.get(i));
            }
        }
        CustomRecyclerDanhGia customRecyclerDanhGia = new CustomRecyclerDanhGia(getActivity(),danhGiaList);
