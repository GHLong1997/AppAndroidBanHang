...
public class Fragment4Sao extends Fragment implements ViewDanhGia{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.layout_fragment_danhgia_4sao,container,false);
